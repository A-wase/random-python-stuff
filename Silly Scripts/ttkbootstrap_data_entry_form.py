# Script Explained:
# - Creates a ttkbootstrap GUI form with multiple input types (text, spinbox, dropdown, checkbox, slider)
# - Uses Bootstrap-themed widgets for modern styling
...
import tkinter as tk  # For base widgets and variables
...
class DataEntryForm:
    def __init__(self, root):
        ...
        # Create form elements with Bootstrap styling
        self.create_widgets()
        
    def create_widgets(self):
        # Form title with primary accent
        title = ttk.Label(
            self.root, 
        ...
        # Gender Combobox
        ttk.Label(self.root, text="Gender:", bootstyle=PRIMARY).grid(
            row=3, column=0, padx=10, pady=5, sticky=tk.W)
        gender_combo = ttk.Combobox(
            self.root, 
            textvariable=self.data["Gender"], 
        ...
        # Email Entry
        ttk.Label(self.root, text="Email:", bootstyle=PRIMARY).grid(
        ...
        # Subscription Checkbutton (toggle switch style)
        ttk.Checkbutton(
            self.root, 
            text="Subscribe to newsletter", 
            variable=self.data["Subscription"],
            bootstyle="success-round-toggle"
        ).grid(row=5, column=1, padx=10, pady=5, sticky=tk.W)
        
        # Satisfaction Scale
        ttk.Label(self.root, text="Satisfaction Level:", bootstyle=PRIMARY).grid(
            row=6, column=0, padx=10, pady=5, sticky=tk.W)
        satisfaction_scale = ttk.Scale(
            self.root, 
            from_=0, 
            to=100, 
            variable=self.data["Satisfaction"],
            orient=HORIZONTAL,
            bootstyle=PRIMARY
        )
        ...
        # Comments Text
        ttk.Label(self.root, text="Comments:", bootstyle=PRIMARY).grid(
...
if __name__ == "__main__":
    ...
    root = ttk.Window(themename="superhero")  # Change theme here: "superhero", "darkly", "cosmo"
